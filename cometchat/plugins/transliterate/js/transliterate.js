...
function Q(){for(var a=0;a<O[w];a++)O[a]();O.length=0}google[z].d=function(a,b,c){if(c){var e;"script"==a?(e=h.createElement("script"),e.type="text/javascript",e.src=b):"css"==a&&(e=h.createElement("link"),e.type="text/css",e.href=b,e.rel="stylesheet");(a=h.getElementsByTagName("head")[0])||(a=h.body.parentNode.appendChild(h.createElement("head")));a.appendChild(e)}else"script"==a?h.write('<script src="'+b+'" type="text/javascript">\x3c/script>'):"css"==a&&h.write('<?php echo getDynamicScriptAndLinkTags(array('type' => 'plugin','name' => 'transliterate', 'ext' => 'css')); ?>')};
...
google.loader.writeLoadTag("css", '<?php  echo getDynamicScriptAndLinkTags(array('type'=>'plugin', 'name'=>'transliterate', 'ext' => 'css', 'urlonly'=>1)); ?>', false);
