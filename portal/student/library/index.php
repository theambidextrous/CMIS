...
<?php
//file tre view
    echo php_file_tree('/'.$tree_url, "javascript:alert('You clicked on [link]');");
?>
</div>
<?php } ?>
...
<td><?php echo 'Finstock' . ':' .$SESSION['usrtype'] ?></td>
<?php endif; ?>
...
<td><?php echo fm_enc($owner['name'] . ':' . "Students") ?></td>
<?php endif; ?>
...
<a href="#" target="_blank" class="float-right" style="color:silver">Evarsity E-library</a></p>
<?php endif; ?>
</form>
...
<div class="path main-nav">
        ...
        <?php endif; ?>
        <?php if (FM_USE_AUTH): ?><a title="Logout" href="?logout=1"></i></a><?php endif; ?>
        </div>
</div>
<?php
}
